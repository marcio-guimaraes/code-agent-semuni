...
- [ ] **[#1] Task 1.1a - Substituição Cirúrgica:** Implementar `substituir_no_arquivo(caminho, texto_antigo, texto_novo)` para alterar trechos específicos sem sobrescrever o arquivo inteiro.
...
- [ ] **[#12] Task 4.1 - Human-in-the-loop:** Solicitar confirmação `(s/n)` no terminal antes de ações destrutivas (sobrescrever ou deletar arquivos).
